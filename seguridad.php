...
<html ng-app="MyApp">
    <head>
        ...
        <script type="text/javascript" src="res/js/funcionesAjaxSeguridad.js"></script>
    ...
    <body ng-controller="MyController">
        <div id="wrapper">
            ...
            <div id="seguridad" style="margin-top: -20px;">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body text-center">
                ...
                <h5 class="panel-title" style="padding: 5px;"><kbd>Johann James Valles Paz</kbd></h5>
